    ...
    StringBuilder _xblockexpression = null;
    {
      ...
      final Consumer<Optional> _function = new Consumer<Optional>() {
        public void accept(final Optional o) {
          ...
          Integer _get = probas.get(_name);
          _builder.append(_get, "");
          _builder.append(")");
          String _plus = (VideoGenChecker.this.tabs + _builder.toString());
          String _plus_1 = (_plus + "\n");
          VideoGenChecker.this.result.append(_plus_1);
          Video _video_1 = o.getVideo();
          VideoGenChecker.this.compile(_video_1);
        }
      };
