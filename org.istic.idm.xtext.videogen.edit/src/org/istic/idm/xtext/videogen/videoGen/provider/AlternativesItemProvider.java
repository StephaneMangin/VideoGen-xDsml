...
/**
 * This is the item provider adapter for a {@link org.istic.idm.xtext.videogen.videoGen.Alternatives} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlternativesItemProvider extends StatementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alternatives_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alternatives_name_feature", "_UI_Alternatives_type"),
				 VideoGenPackage.Literals.ALTERNATIVES__NAME,
				 true,
				 false,
				 false,
