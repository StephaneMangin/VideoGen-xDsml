...
/**
 * This is the item provider adapter for a {@link org.istic.idm.xtext.videogen.videoGen.Sequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceItemProvider 
	...
	protected void addUrlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sequence_url_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sequence_url_feature", "_UI_Sequence_type"),
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sequence_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sequence_description_feature", "_UI_Sequence_type"),
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sequence_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sequence_length_feature", "_UI_Sequence_type"),
				 VideoGenPackage.Literals.SEQUENCE__LENGTH,
				 true,
				 false,
				 false,
	...
	protected void addMimetypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sequence_mimetype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sequence_mimetype_feature", "_UI_Sequence_type"),
				 VideoGenPackage.Literals.SEQUENCE__MIMETYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public ResourceLocator getResourceLocator() {
		return VideoGenEditPlugin.INSTANCE;
	}
