 ...
 * <ul>
 *   <li>{@link videoGen.impl.VideoImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link videoGen.impl.VideoImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link videoGen.impl.VideoImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link videoGen.impl.VideoImpl#getMimetype <em>Mimetype</em>}</li>
 *   <li>{@link videoGen.impl.VideoImpl#getSelected <em>Selected</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VideoImpl extends NamedElementImpl implements Video {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case VideoGenPackage.VIDEO___SELECT:
				select();
				return null;
		}
