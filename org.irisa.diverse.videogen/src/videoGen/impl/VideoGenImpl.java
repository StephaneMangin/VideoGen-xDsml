...
public class VideoGenImpl extends NamedElementImpl implements VideoGen {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case VideoGenPackage.VIDEO_GEN___MIN_DURATION:
				return minDuration();
			case VideoGenPackage.VIDEO_GEN___MAX_DURATION:
				return maxDuration();
			case VideoGenPackage.VIDEO_GEN___MIN_SEQUENCE:
				return minSequence();
			case VideoGenPackage.VIDEO_GEN___MAX_SEQUENCE:
				return maxSequence();
			case VideoGenPackage.VIDEO_GEN___INITIALIZE:
				initialize();
				return null;
			case VideoGenPackage.VIDEO_GEN___COMPUTE:
				return compute();
		}
