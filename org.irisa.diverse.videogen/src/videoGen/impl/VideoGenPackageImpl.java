...
public class VideoGenPackageImpl extends EPackageImpl implements VideoGenPackage {
	 ...
	 * @see videoGen.VideoGenPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EOperation getVideoGen__Initialize() {
		return videoGenEClass.getEOperations().get(4);
	}
	 ...
	 * @generated
	 */
	public EOperation getVideoGen__Compute() {
		return videoGenEClass.getEOperations().get(5);
	}
	 ...
	 * @generated
	 */
	public EOperation getSequence__Process() {
	 ...
	 * @generated
	 */
	public EOperation getVideo__Select() {
	...
	public void createPackageContents() {
		...
		createEOperation(videoGenEClass, VIDEO_GEN___INITIALIZE);
		createEOperation(videoGenEClass, VIDEO_GEN___COMPUTE);

		sequenceEClass = createEClass(SEQUENCE);
		createEReference(sequenceEClass, SEQUENCE__NEXT_SIBLING);
		createEOperation(sequenceEClass, SEQUENCE___PROCESS);
		...
		createEOperation(videoEClass, VIDEO___SELECT);
	...
	public void initializePackageContents() {
		...
		initEOperation(getVideoGen__Initialize(), null, "initialize", 1, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getVideoGen__Compute(), this.getVideo(), "compute", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getSequence__Process(), null, "process", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getVideo__Select(), null, "select", 1, 1, IS_UNIQUE, IS_ORDERED);
