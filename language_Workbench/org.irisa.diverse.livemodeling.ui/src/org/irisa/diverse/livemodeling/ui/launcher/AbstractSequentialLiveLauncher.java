...
abstract public class AbstractSequentialLiveLauncher extends AbstractLiveLauncher {
			...
			Job job = new Job(getDebugJobName(configuration, getFirstInstruction(configuration))) {
				...
				protected IStatus run(IProgressMonitor monitor) {
					...
					if (ILaunchManager.DEBUG_MODE.equals(mode)) {
						...
						try {
							AbstractSequentialLiveLauncher.super.launch(configuration, mode, launch, monitor);
