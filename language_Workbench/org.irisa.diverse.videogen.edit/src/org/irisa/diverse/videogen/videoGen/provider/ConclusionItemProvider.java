 ...
 * @generated
 */
public class ConclusionItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VideoGenPackage.Literals.CONCLUSION__VIDEOGEN,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Conclusion.class)) {
