...
import org.irisa.diverse.videogen.videogenl.videoGen.NamedElement;
...
import org.irisa.diverse.videogen.videogenl.videoGen.VideoGenFactory;
import org.irisa.diverse.videogen.videogenl.videoGen.VideoGenPackage;

import org.irisa.diverse.videogen.videogenl.videoGen.util.VideoGenValidator;
...
public class VideoGenPackageImpl extends EPackageImpl implements VideoGenPackage {
	 ...
	 * @see org.irisa.diverse.videogen.videogenl.videoGen.VideoGenPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getVideoGen_Initialized() {
		return (EAttribute)videoGenEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EReference getTransition_VideoGen() {
	 ...
	 * @generated
	 */
	public EAttribute getTransition_Executed() {
	 ...
	 * @generated
	 */
	public EAttribute getTransition_CallnextTransition() {
	...
	public void createPackageContents() {
		...
		createEAttribute(videoGenEClass, VIDEO_GEN__INITIALIZED);
		...
		createEReference(transitionEClass, TRANSITION__VIDEO_GEN);
		createEAttribute(transitionEClass, TRANSITION__EXECUTED);
		createEAttribute(transitionEClass, TRANSITION__CALLNEXT_TRANSITION);
	...
	public void initializePackageContents() {
		...
		EOperation op = addEOperation(mandatoryEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getVideoGen(), "vid", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(initializeEClass, Initialize.class, "Initialize", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(initializeEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getVideoGen(), "vid", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getVideoGen_Initialized(), ecorePackage.getEBoolean(), "initialized", null, 0, 1, VideoGen.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(videoGenEClass, null, "main", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(videoGenEClass, this.getBasicEMap(), "solve", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(videoGenEClass, null, "initializeModel", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "args", 0, -1, IS_UNIQUE, IS_ORDERED);

		addEOperation(videoGenEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getTransition_VideoGen(), this.getVideoGen(), null, "videoGen", null, 0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTransition_Executed(), ecorePackage.getEBooleanObject(), "executed", null, 0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTransition_CallnextTransition(), ecorePackage.getEBooleanObject(), "callnextTransition", null, 0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = addEOperation(transitionEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getVideoGen(), "videoGen", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(transitionEClass, null, "finishExecute", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getVideoGen(), "videoGen", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(transitionEClass, null, "addNumber", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "key", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDouble(), "distribution", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(transitionEClass, ecorePackage.getEInt(), "getDistributedRandomNumber", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(optionalEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getVideoGen(), "vid", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(videoEClass, null, "setup", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(alternativesEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getVideoGen(), "vid", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(alternativesEClass, this.getOptional(), "selectOption", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(generateEClass, Generate.class, "Generate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(generateEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getVideoGen(), "vid", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (initializeEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (getTransition_VideoGen(), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (getTransition_Executed(), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (getTransition_CallnextTransition(), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (generateEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
