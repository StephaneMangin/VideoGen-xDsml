...
public class VideoGenPackageImpl extends EPackageImpl implements VideoGenPackage {
	...
	public void initializePackageContents() {
		...
		op = addEOperation(generateEClass, null, "compute", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getVideoGen(), "videoGen", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(sequenceEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getVideoGen(), "videoGen", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (generateEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
