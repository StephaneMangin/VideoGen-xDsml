 ...
 * </p>
 * <ul>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.InitializeImpl#getNextTransition <em>Next Transition</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.InitializeImpl#getActive <em>Active</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.InitializeImpl#getSelected <em>Selected</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InitializeImpl extends NamedElementImpl implements Initialize {
	...
	protected EClass eStaticClass() {
		return VideogenlPackage.Literals.INITIALIZE;
	}
		...
		if (nextTransition != null && nextTransition.eIsProxy()) {
			...
			if (nextTransition != oldNextTransition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VideogenlPackage.INITIALIZE__NEXT_TRANSITION, oldNextTransition, nextTransition));
			}
		}
	...
	public void setNextTransition(Transition newNextTransition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.INITIALIZE__NEXT_TRANSITION, oldNextTransition, nextTransition));
	}
	...
	public void setActive(Boolean newActive) {
		...
		active = newActive;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.INITIALIZE__ACTIVE, oldActive, active));
	}
	...
	public void setSelected(Boolean newSelected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.INITIALIZE__SELECTED, oldSelected, selected));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VideogenlPackage.INITIALIZE__NEXT_TRANSITION:
				if (resolve) return getNextTransition();
				return basicGetNextTransition();
			case VideogenlPackage.INITIALIZE__ACTIVE:
				return getActive();
			case VideogenlPackage.INITIALIZE__SELECTED:
				return getSelected();
		}
