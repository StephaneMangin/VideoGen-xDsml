 ...
 * </p>
 * <ul>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.GenerateImpl#getNextTransition <em>Next Transition</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.GenerateImpl#getActive <em>Active</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.GenerateImpl#getSelected <em>Selected</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenerateImpl extends NamedElementImpl implements Generate {
	...
	protected EClass eStaticClass() {
		return VideogenlPackage.Literals.GENERATE;
	}
		...
		if (nextTransition != null && nextTransition.eIsProxy()) {
			...
			if (nextTransition != oldNextTransition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VideogenlPackage.GENERATE__NEXT_TRANSITION, oldNextTransition, nextTransition));
			}
		}
	...
	public void setNextTransition(Transition newNextTransition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.GENERATE__NEXT_TRANSITION, oldNextTransition, nextTransition));
	}
	...
	public void setActive(Boolean newActive) {
		...
		active = newActive;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.GENERATE__ACTIVE, oldActive, active));
	}
	...
	public void setSelected(Boolean newSelected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.GENERATE__SELECTED, oldSelected, selected));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VideogenlPackage.GENERATE__NEXT_TRANSITION:
				if (resolve) return getNextTransition();
				return basicGetNextTransition();
			case VideogenlPackage.GENERATE__ACTIVE:
				return getActive();
			case VideogenlPackage.GENERATE__SELECTED:
				return getSelected();
		}
