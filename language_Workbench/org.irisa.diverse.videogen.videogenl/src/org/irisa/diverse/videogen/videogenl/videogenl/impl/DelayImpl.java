 ...
 * </p>
 * <ul>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.DelayImpl#getNextTransition <em>Next Transition</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.DelayImpl#getActive <em>Active</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.DelayImpl#getSelected <em>Selected</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.DelayImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DelayImpl extends NamedElementImpl implements Delay {
	...
	protected EClass eStaticClass() {
		return VideogenlPackage.Literals.DELAY;
	}
		...
		if (nextTransition != null && nextTransition.eIsProxy()) {
			...
			if (nextTransition != oldNextTransition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VideogenlPackage.DELAY__NEXT_TRANSITION, oldNextTransition, nextTransition));
			}
		}
	...
	public void setNextTransition(Transition newNextTransition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.DELAY__NEXT_TRANSITION, oldNextTransition, nextTransition));
	}
	...
	public void setActive(Boolean newActive) {
		...
		active = newActive;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.DELAY__ACTIVE, oldActive, active));
	}
	...
	public void setSelected(Boolean newSelected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.DELAY__SELECTED, oldSelected, selected));
	}
	...
	public void setValue(Integer newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.DELAY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VideogenlPackage.DELAY__NEXT_TRANSITION:
				if (resolve) return getNextTransition();
				return basicGetNextTransition();
			case VideogenlPackage.DELAY__ACTIVE:
				return getActive();
			case VideogenlPackage.DELAY__SELECTED:
				return getSelected();
			case VideogenlPackage.DELAY__VALUE:
				return getValue();
		}
