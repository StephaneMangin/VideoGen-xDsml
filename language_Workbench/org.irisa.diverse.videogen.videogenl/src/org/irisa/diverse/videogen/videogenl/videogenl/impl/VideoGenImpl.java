 ...
 * </p>
 * <ul>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoGenImpl#getMinDurationConstraint <em>Min Duration Constraint</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoGenImpl#getMaxDurationConstraint <em>Max Duration Constraint</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoGenImpl#getVariantes <em>Variantes</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoGenImpl#getTransitions <em>Transitions</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoGenImpl#getVideos <em>Videos</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoGenImpl#getMinUserConstraint <em>Min User Constraint</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoGenImpl#getMaxUserConstraint <em>Max User Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VideoGenImpl extends NamedElementImpl implements VideoGen {
	...
	protected EClass eStaticClass() {
		return VideogenlPackage.Literals.VIDEO_GEN;
	}
	...
	public void setMinDurationConstraint(Integer newMinDurationConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.VIDEO_GEN__MIN_DURATION_CONSTRAINT, oldMinDurationConstraint, minDurationConstraint));
	}
	...
	public void setMaxDurationConstraint(Integer newMaxDurationConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.VIDEO_GEN__MAX_DURATION_CONSTRAINT, oldMaxDurationConstraint, maxDurationConstraint));
	}
	...
	public void setVariantes(Integer newVariantes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.VIDEO_GEN__VARIANTES, oldVariantes, variantes));
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, VideogenlPackage.VIDEO_GEN__TRANSITIONS);
		}
		return transitions;
	}
	...
	public EList<Video> getVideos() {
		if (videos == null) {
			videos = new EObjectContainmentEList<Video>(Video.class, this, VideogenlPackage.VIDEO_GEN__VIDEOS);
		}
		return videos;
	}
	...
	public void setMinUserConstraint(Integer newMinUserConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.VIDEO_GEN__MIN_USER_CONSTRAINT, oldMinUserConstraint, minUserConstraint));
	}
	...
	public void setMaxUserConstraint(Integer newMaxUserConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.VIDEO_GEN__MAX_USER_CONSTRAINT, oldMaxUserConstraint, maxUserConstraint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case VideogenlPackage.VIDEO_GEN__TRANSITIONS:
				return ((InternalEList<?>)getTransitions()).basicRemove(otherEnd, msgs);
			case VideogenlPackage.VIDEO_GEN__VIDEOS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VideogenlPackage.VIDEO_GEN__MIN_DURATION_CONSTRAINT:
				return getMinDurationConstraint();
			case VideogenlPackage.VIDEO_GEN__MAX_DURATION_CONSTRAINT:
				return getMaxDurationConstraint();
			case VideogenlPackage.VIDEO_GEN__VARIANTES:
				return getVariantes();
			case VideogenlPackage.VIDEO_GEN__TRANSITIONS:
				return getTransitions();
			case VideogenlPackage.VIDEO_GEN__VIDEOS:
				return getVideos();
			case VideogenlPackage.VIDEO_GEN__MIN_USER_CONSTRAINT:
				return getMinUserConstraint();
			case VideogenlPackage.VIDEO_GEN__MAX_USER_CONSTRAINT:
