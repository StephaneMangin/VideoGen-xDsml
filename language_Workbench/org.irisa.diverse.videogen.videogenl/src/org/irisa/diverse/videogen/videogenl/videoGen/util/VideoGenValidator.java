...
public class VideoGenValidator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case VideoGenPackage.BASIC_EMAP:
				return validateBasicEMap((BasicEMap)value, diagnostics, context);
			default:
				return true;
		}
	}
	 ...
	 * @generated
	 */
	public boolean validateBasicEMap(BasicEMap basicEMap, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
