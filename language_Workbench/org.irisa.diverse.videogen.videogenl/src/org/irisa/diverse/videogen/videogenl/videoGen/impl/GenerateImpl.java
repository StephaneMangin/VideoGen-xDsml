 ...
 * </p>
 * <ul>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videoGen.impl.GenerateImpl#getNextTransition <em>Next Transition</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videoGen.impl.GenerateImpl#getActive <em>Active</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videoGen.impl.GenerateImpl#getSelected <em>Selected</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videoGen.impl.GenerateImpl#getVideoGen <em>Video Gen</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videoGen.impl.GenerateImpl#getExecuted <em>Executed</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videoGen.impl.GenerateImpl#getCallnextTransition <em>Callnext Transition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenerateImpl extends NamedElementImpl implements Generate {
	...
	public VideoGen getVideoGen() {
		if (videoGen != null && videoGen.eIsProxy()) {
			...
			if (videoGen != oldVideoGen) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VideoGenPackage.GENERATE__VIDEO_GEN, oldVideoGen, videoGen));
			}
		}
		return videoGen;
	}
	...
	public void setVideoGen(VideoGen newVideoGen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideoGenPackage.GENERATE__VIDEO_GEN, oldVideoGen, videoGen));
	}
	...
	public void setExecuted(Boolean newExecuted) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideoGenPackage.GENERATE__EXECUTED, oldExecuted, executed));
	}
	...
	public void setCallnextTransition(Boolean newCallnextTransition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideoGenPackage.GENERATE__CALLNEXT_TRANSITION, oldCallnextTransition, callnextTransition));
	}
	 ...
	 * @generated
	 */
	public void compute(VideoGen videoGen) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case VideoGenPackage.GENERATE__SELECTED:
				return getSelected();
			case VideoGenPackage.GENERATE__VIDEO_GEN:
				if (resolve) return getVideoGen();
				return basicGetVideoGen();
			case VideoGenPackage.GENERATE__EXECUTED:
				return getExecuted();
			case VideoGenPackage.GENERATE__CALLNEXT_TRANSITION:
