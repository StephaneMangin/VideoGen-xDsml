 ...
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videoGen.impl.VideoGenImpl#isInitialized <em>Initialized</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VideoGenImpl extends NamedElementImpl implements VideoGen {
	...
	public void setInitialized(boolean newInitialized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideoGenPackage.VIDEO_GEN__INITIALIZED, oldInitialized, initialized));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case VideoGenPackage.VIDEO_GEN__INITIALIZED:
