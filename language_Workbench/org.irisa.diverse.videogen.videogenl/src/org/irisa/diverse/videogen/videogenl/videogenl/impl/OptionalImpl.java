 ...
 * </p>
 * <ul>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.OptionalImpl#getProbability <em>Probability</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OptionalImpl extends SequenceImpl implements Optional {
	/**
	...
	protected EClass eStaticClass() {
		return VideogenlPackage.Literals.OPTIONAL;
	}
	...
	public void setProbability(Integer newProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.OPTIONAL__PROBABILITY, oldProbability, probability));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VideogenlPackage.OPTIONAL__PROBABILITY:
