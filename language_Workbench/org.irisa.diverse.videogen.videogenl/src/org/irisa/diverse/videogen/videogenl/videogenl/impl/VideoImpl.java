 ...
 * </p>
 * <ul>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link org.irisa.diverse.videogen.videogenl.videogenl.impl.VideoImpl#getMimetype <em>Mimetype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VideoImpl extends NamedElementImpl implements Video {
	...
	protected EClass eStaticClass() {
		return VideogenlPackage.Literals.VIDEO;
	}
	...
	public void setUrl(String newUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.VIDEO__URL, oldUrl, url));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.VIDEO__DESCRIPTION, oldDescription, description));
	}
	...
	public void setDuration(Integer newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.VIDEO__DURATION, oldDuration, duration));
	}
	...
	public void setMimetype(Mimetypes_Enum newMimetype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VideogenlPackage.VIDEO__MIMETYPE, oldMimetype, mimetype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VideogenlPackage.VIDEO__URL:
				return getUrl();
			case VideogenlPackage.VIDEO__DESCRIPTION:
				return getDescription();
			case VideogenlPackage.VIDEO__DURATION:
				return getDuration();
			case VideogenlPackage.VIDEO__MIMETYPE:
				return getMimetype();
		}
