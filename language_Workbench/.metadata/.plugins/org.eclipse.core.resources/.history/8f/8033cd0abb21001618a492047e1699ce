package org.irisa.diverse.videogen.videogenl.solvers
...
import org.irisa.diverse.videogen.videogenl.solvers.helpers.VideoGenHelper
...
class VideoGenUserContraintsVisitor extends LoggableVisitor {
    ...
    def private int videosNumber(VideoGen vid) {
    	VideoGenHelper.allVideos(vid).size
