 ...
 *******************************************************************************/
package org.irisa.diverse.livemodeling.extensions.sirius.modelloader;
...
import org.irisa.diverse.livemodeling.extensions.sirius.Activator;

import fr.obeo.dsl.debug.ide.sirius.ui.services.AbstractDSLDebuggerServices;

@SuppressWarnings("restriction")
public class LiveModelLoader implements IModelLoader {
...
//				System.out.println("+\t\t" + "Saving policy: " + session.getSavingPolicy());
	...
	private void killPreviousSiriusSession(URI sessionResourceURI) {
		...
		if (session != null) {
			...
			LivePermissionProvider permProvider = new LivePermissionProvider();
...
//		System.out.println("\t" + "AIRD URI : " + airdURI);
		...
		final Session session = LiveSessionFactory.INSTANCE.createSession(rs, airdURI);
...
//				}
	...
	private ResourceSet createAndConfigureResourceSet(URI modelURI, HashMap<String, String> nsURIMapping) {
		...
		converter.getURIHandlers().add(0, new LiveURIHandler());
		return rs;
	}
