...
public class VideoGenTraceConstructor implements ITraceConstructor {
	...
	public void addStep(fr.inria.diverse.trace.commons.model.trace.Step step) {
		...
		if (step != null && step instanceof videoGenTrace.Steps.SpecificStep) {
			...
			} else if (step_cast instanceof videoGenTrace.Steps.VideoGen_VideoGen_Solve) {
				videoGenTrace.Steps.VideoGen_VideoGen_Solve videoGen_VideoGen_SolveInstance = (videoGenTrace.Steps.VideoGen_VideoGen_Solve) step_cast;
				traceRoot.getVideoGen_VideoGen_Solve_Sequence().add(videoGen_VideoGen_SolveInstance);
			}
		}
