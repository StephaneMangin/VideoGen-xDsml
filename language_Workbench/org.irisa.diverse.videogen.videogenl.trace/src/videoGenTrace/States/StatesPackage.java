...
public interface StatesPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Video Gen initialized Values</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int STATE__VIDEO_GEN_INITIALIZED_VALUES = 5;
	...
	/**
	 * The meta object id for the '{@link videoGenTrace.States.impl.VideoGen_initialized_ValueImpl <em>Video Gen initialized Value</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see videoGenTrace.States.impl.VideoGen_initialized_ValueImpl
	 * @see videoGenTrace.States.impl.StatesPackageImpl#getVideoGen_initialized_Value()
	 * @generated
	 */
	int VIDEO_GEN_INITIALIZED_VALUE = 5;
	 ...
	 * @ordered
	 */
	int VIDEO_GEN_INITIALIZED_VALUE__STATES_NO_OPPOSITE = VALUE__STATES_NO_OPPOSITE;
	 ...
	 * @ordered
	 */
	int VIDEO_GEN_INITIALIZED_VALUE__INITIALIZED = VALUE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int VIDEO_GEN_INITIALIZED_VALUE__PARENT = VALUE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int VIDEO_GEN_INITIALIZED_VALUE__STATES = VALUE_FEATURE_COUNT + 2;

	/**
	 * The number of structural features of the '<em>Video Gen initialized Value</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int VIDEO_GEN_INITIALIZED_VALUE_FEATURE_COUNT = VALUE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int VIDEO_GEN_INITIALIZED_VALUE___GET_STATES_NO_OPPOSITE = VALUE_OPERATION_COUNT + 0;

	/**
	 * The number of operations of the '<em>Video Gen initialized Value</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int VIDEO_GEN_INITIALIZED_VALUE_OPERATION_COUNT = VALUE_OPERATION_COUNT + 1;
	...
	/**
	 * Returns the meta object for the reference list '{@link videoGenTrace.States.State#getVideoGen_initialized_Values <em>Video Gen initialized Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Video Gen initialized Values</em>'.
	 * @see videoGenTrace.States.State#getVideoGen_initialized_Values()
	 * @see #getState()
	 * @generated
	 */
	EReference getState_VideoGen_initialized_Values();
	...
	/**
	 * Returns the meta object for class '{@link videoGenTrace.States.VideoGen_initialized_Value <em>Video Gen initialized Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Video Gen initialized Value</em>'.
	 * @see videoGenTrace.States.VideoGen_initialized_Value
	 * @generated
	 */
	EClass getVideoGen_initialized_Value();

	/**
	 * Returns the meta object for the attribute '{@link videoGenTrace.States.VideoGen_initialized_Value#isInitialized <em>Initialized</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Initialized</em>'.
	 * @see videoGenTrace.States.VideoGen_initialized_Value#isInitialized()
	 * @see #getVideoGen_initialized_Value()
	 * @generated
	 */
	EAttribute getVideoGen_initialized_Value_Initialized();

	/**
	 * Returns the meta object for the container reference '{@link videoGenTrace.States.VideoGen_initialized_Value#getParent <em>Parent</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Parent</em>'.
	 ...
	 * @generated
	 */
	EReference getVideoGen_initialized_Value_Parent();

	/**
	 * Returns the meta object for the reference list '{@link videoGenTrace.States.VideoGen_initialized_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>States</em>'.
	 * @see videoGenTrace.States.VideoGen_initialized_Value#getStates()
	 * @see #getVideoGen_initialized_Value()
	 * @generated
	 */
	EReference getVideoGen_initialized_Value_States();

	/**
	 * Returns the meta object for the '{@link videoGenTrace.States.VideoGen_initialized_Value#getStatesNoOpposite() <em>Get States No Opposite</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get States No Opposite</em>' operation.
	 * @see videoGenTrace.States.VideoGen_initialized_Value#getStatesNoOpposite()
	 * @generated
	 */
	EOperation getVideoGen_initialized_Value__GetStatesNoOpposite();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Video Gen initialized Values</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference STATE__VIDEO_GEN_INITIALIZED_VALUES = eINSTANCE.getState_VideoGen_initialized_Values();
		...
		/**
		 * The meta object literal for the '{@link videoGenTrace.States.impl.VideoGen_initialized_ValueImpl <em>Video Gen initialized Value</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see videoGenTrace.States.impl.VideoGen_initialized_ValueImpl
		 * @see videoGenTrace.States.impl.StatesPackageImpl#getVideoGen_initialized_Value()
		 * @generated
		 */
		EClass VIDEO_GEN_INITIALIZED_VALUE = eINSTANCE.getVideoGen_initialized_Value();
		 ...
		 * @generated
		 */
		EAttribute VIDEO_GEN_INITIALIZED_VALUE__INITIALIZED = eINSTANCE.getVideoGen_initialized_Value_Initialized();
		 ...
		 * @generated
		 */
		EReference VIDEO_GEN_INITIALIZED_VALUE__PARENT = eINSTANCE.getVideoGen_initialized_Value_Parent();
		 ...
		 * @generated
		 */
		EReference VIDEO_GEN_INITIALIZED_VALUE__STATES = eINSTANCE.getVideoGen_initialized_Value_States();
		 ...
		 * @generated
		 */
		EOperation VIDEO_GEN_INITIALIZED_VALUE___GET_STATES_NO_OPPOSITE = eINSTANCE.getVideoGen_initialized_Value__GetStatesNoOpposite();
