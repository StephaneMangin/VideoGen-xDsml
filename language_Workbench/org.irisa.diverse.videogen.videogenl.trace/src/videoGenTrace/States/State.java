 ...
 *   <li>{@link videoGenTrace.States.State#getVideoGen_initialized_Values <em>Video Gen initialized Values</em>}</li>
 * </ul>
 *
...
public interface State extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Video Gen initialized Values</b></em>' reference list.
	 * The list contents are of type {@link videoGenTrace.States.VideoGen_initialized_Value}.
	 * It is bidirectional and its opposite is '{@link videoGenTrace.States.VideoGen_initialized_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Video Gen initialized Values</em>' reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Video Gen initialized Values</em>' reference list.
	 * @see videoGenTrace.States.StatesPackage#getState_VideoGen_initialized_Values()
	 * @see videoGenTrace.States.VideoGen_initialized_Value#getStates
	 * @model opposite="states" ordered="false"
	 * @generated
	 */
	EList<VideoGen_initialized_Value> getVideoGen_initialized_Values();
