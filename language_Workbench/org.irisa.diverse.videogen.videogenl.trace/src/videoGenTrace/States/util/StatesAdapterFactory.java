...
public class StatesAdapterFactory extends AdapterFactoryImpl {
	...
	protected StatesSwitch<Adapter> modelSwitch =
		new StatesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseVideoGen_initialized_Value(VideoGen_initialized_Value object) {
				return createVideoGen_initialized_ValueAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link videoGenTrace.States.State <em>State</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link videoGenTrace.States.Value <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link videoGenTrace.States.VideoGen_initialized_Value <em>Video Gen initialized Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVideoGen_initialized_ValueAdapter() {
		return null;
	}
