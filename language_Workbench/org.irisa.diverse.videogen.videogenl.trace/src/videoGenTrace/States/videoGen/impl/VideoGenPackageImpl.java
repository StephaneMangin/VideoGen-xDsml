...
public class VideoGenPackageImpl extends EPackageImpl implements VideoGenPackage {
	 ...
	 * @generated
	 */
	public EReference getTracedVideoGen_InitializedSequence() {
	...
	public EReference getTracedVideoGen_OriginalObject() {
		return (EReference)tracedVideoGenEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(tracedVideoGenEClass, TRACED_VIDEO_GEN__INITIALIZED_SEQUENCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getTracedVideoGen_InitializedSequence(), theStatesPackage.getVideoGen_initialized_Value(), theStatesPackage.getVideoGen_initialized_Value_Parent(), "initializedSequence", null, 0, -1, TracedVideoGen.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
