...
public class VideoGen_Generate_ExecuteImpl extends StepImpl implements VideoGen_Generate_Execute {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.VIDEO_GEN_GENERATE_EXECUTE__SUB_STEPS: return MsePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case MsePackage.BIG_STEP__SUB_STEPS: return StepsPackage.VIDEO_GEN_GENERATE_EXECUTE__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
