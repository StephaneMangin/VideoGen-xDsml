...
public class StepsAdapterFactory extends AdapterFactoryImpl {
	...
	protected StepsSwitch<Adapter> modelSwitch =
		new StepsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseVideoGen_Generate_Compute_AbstractSubStep(VideoGen_Generate_Compute_AbstractSubStep object) {
				return createVideoGen_Generate_Compute_AbstractSubStepAdapter();
			}
			@Override
			public Adapter caseVideoGen_Generate_Compute_ImplicitStep(VideoGen_Generate_Compute_ImplicitStep object) {
				return createVideoGen_Generate_Compute_ImplicitStepAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link videoGenTrace.Steps.VideoGen_Generate_Compute_AbstractSubStep <em>Video Gen Generate Compute Abstract Sub Step</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVideoGen_Generate_Compute_AbstractSubStepAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link videoGenTrace.Steps.VideoGen_Generate_Compute_ImplicitStep <em>Video Gen Generate Compute Implicit Step</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVideoGen_Generate_Compute_ImplicitStepAdapter() {
		return null;
	}
