...
public class IntroductionAdapter extends EObjectAdapter<Introduction> implements org.irisa.diverse.videogen.videogenlmt.videoGen.Introduction {
  ...
  public EClass eClass() {
    return org.irisa.diverse.videogen.videogenlmt.videoGen.VideoGenPackage.eINSTANCE.getIntroduction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.irisa.diverse.videogen.videogenlmt.videoGen.VideoGenPackage.INTRODUCTION__NAME:
    		return getName();
    	case org.irisa.diverse.videogen.videogenlmt.videoGen.VideoGenPackage.INTRODUCTION__NEXT_SEQUENCE:
    		return getNextSequence();
    	case org.irisa.diverse.videogen.videogenlmt.videoGen.VideoGenPackage.INTRODUCTION__ACTIVE:
    		return isActive() ? Boolean.TRUE : Boolean.FALSE;
    	case org.irisa.diverse.videogen.videogenlmt.videoGen.VideoGenPackage.INTRODUCTION__VIDEO:
    		return getVideo();
    	case org.irisa.diverse.videogen.videogenlmt.videoGen.VideoGenPackage.INTRODUCTION__VIDEOGEN:
    		return getVideogen();
    }
